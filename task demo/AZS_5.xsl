  ...
  <div class="smp-search-form">
    <form method="get">
      ...
      <table class="smp-search-form-table" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
        ...
        <xsl:apply-templates select="fieldList/usr_answer_status" />
...
<xsl:template match="usr_registDate">
  <tr class="smp-sf-row">
    <td class="smp-sf-head" style="border:1px solid #999999; padding:5px; font-size:9pt; color:#202020; font-weight:bold; background-color:#FF0000; width:150px;">
      登録日時
    </td>
...
<!-- 回答ステータス -->
<xsl:template match="usr_answer_status">
  <tr class="smp-sf-row" style="display:none;">
    <td class="smp-sf-head" style="border:1px solid #999999; padding:5px; font-size:9pt; color:#202020; font-weight:bold; background-color:#DEDEDE; width:150px;">
      回答ステータス
    </td>
    <td class="smp-sf-body" style="border:1px solid #999999; padding:5px; background-color:#FFFFFF; font-size:9pt; width:300px; display:none;">
      <table style="width:100%; font-size:inherit; font-weight:inherit; color:inherit;">
        <tr>
          <td>
            <div>
