                ...
                <xsl:for-each select="data/record">
                    ...
                    <tr style="height:20;">
                        ...
                        <td class="smp-cell-data smp-cell-{$row}-5 smp-cell smp-cell-row-{$row} smp-cell-col-5"
                            ...
                            <a href="https://ctr34.smp.ne.jp/spiral/servlet/member.parts.SettingTable?_application_id=50&amp;_act=UseCard&amp;_card_page_id=213179&amp;_card_member_id={$id}&amp;_card_db_id=165255&amp;45652_4379887_1={$usr_companyID}&amp;46095_4414157_1={$usr_companyID}&amp;company_id={$usr_companyID}&amp;46095_4414161_1={$usr_department_id}" target="_self">
                                <xsl:value-of select="usr_companyID" />
                            </a>
                        </td>
