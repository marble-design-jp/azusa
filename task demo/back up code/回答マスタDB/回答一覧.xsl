            ...
            function updateUrl(event, type = '') {
                ...
                if(type == 2) {
                    ...
                    if(userKind == 2){
                        ...
                        newUrlSearchParams.set('46375_4401765_1', departmentId);
                        newUrlSearchParams.set('46374_4401765_1', departmentId);
                    }
                    if(userKind == 3){
                        ...
                        newUrlSearchParams.set('46375_4414151_1', userKind);
                        newUrlSearchParams.set('46374_4414151_1', userKind);
                    }
                    ...
                    newUrlSearchParams.set('46375_4379887_1', companyId);
                    newUrlSearchParams.set('46374_4379887_1', companyId);
                } else {
