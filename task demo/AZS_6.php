...
<body>
    ...
    <!-- <p>
        ...
        if ($SPIRAL->getContextByFieldTitle("kind") == 3) {
            echo "<a href='%url/rel:mpgt:azusa_task16%&45652_4401768_1=%val:usr:loginID%&45652_4401770_1=%val:usr:loginID%&45652_4401772_1=%val:usr:loginID%&45652_4401774_1=%val:usr:loginID%&45652_4401776_1=%val:usr:loginID%'>User</a><br>";
        }
        ?>
    </p> -->
</body>
