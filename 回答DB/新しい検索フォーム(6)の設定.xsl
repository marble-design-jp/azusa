...
<xsl:template match="usr_depart">
  <tr class="smp-sf-row" style="display:none">
    <td class="smp-sf-head" style="display:none; border:1px solid #999999; padding:5px; font-size:9pt; color:#202020; font-weight:bold; background-color:#DEDEDE; width:150px">
      部署
    </td>
    <td class="smp-sf-body" style="border:1px solid #999999; padding:5px; background-color:#FFFFFF; font-size:9pt; width:300px">
      <table style="width:100%; font-size:inherit; font-weight:inherit; color:inherit;">
...
<xsl:template match="usr_search_id">
  <tr class="smp-sf-row" style="display:none">
    ...
    <td class="smp-sf-body" style="display:none; border:1px solid #999999; padding:5px; background-color:#FFFFFF; font-size:9pt; width:300px">
      <table style="width:100%; font-size:inherit; font-weight:inherit; color:inherit;">
        <tr>
          <td style="display:none;">
            <input type="hidden" name="{option/exType/@name}" value="16" />
