...
<xsl:stylesheet version="1.0"
    ...
    <div class="search_form">
      ...
      $hidden:sf:extension$
          <table class="smp-search-form-table" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
            <xsl:apply-templates select="fieldList/usr_ans_applystatus" />
            <xsl:apply-templates select="fieldList/sys_multiSearch" />
            <tr class="smp-sf-row">
              <td colspan="2" align="center">
                <div class="serch_btn">
                  <input style="margin:5px;" type="submit" name="smp_sf_button_46310" value="検索" />
                </div>
              </td>
            </tr>
          </table>
  ...
  <!-- ステータス -->
  <xsl:template match="usr_ans_applystatus">
    <tr class="smp-sf-row">
